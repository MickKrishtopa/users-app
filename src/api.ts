...
export const requestUsers = (params: Query = baseQuery): Promise<User[]> => {
    const users: User[] = [
        ...
        { name: "Joe", id: 11, age: 45 },
        { name: "Liza", id: 12, age: 21 },
        { name: "Mikky", id: 13, age: 99 },
        { name: "Jenifer", id: 14, age: 32 },
        { name: "Betany", id: 15, age: 6 },
        { name: "Kate", id: 16, age: 1 },
        { name: "Rendel", id: 17, age: 76 },
        { name: "Romany", id: 18, age: 54 },
        { name: "Tess", id: 19, age: 32 },
    ];
